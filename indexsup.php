        ...
        <div class="col-md-15">
            ...
            <div class="card ">
                ...
                <div class="card-header text-left bg-primary">
                    <a class="btn btn-light btn-md" href="../OPTICA3/clientes.php" role="button" style="color: #000000;";>REGISTRO CLIENTES</a>
                    <a class="btn btn-light btn-md" target="_bank" href="../OPTICA3/doc/indexcli.php" role="button" style="color: #000000;";>REPORTE CLIENTES</a>
                </div>
                <div class="p-4">
                    <table class="table align-middle ">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td><img src='<?php echo $dato->imagencli; ?>' class="img-fluid";></td>
                                <td><?php echo $dato->nombre_cli; ?></td>
                                <td><?php echo $dato->edad_cli; ?></td>
                                <td><?php echo $dato->cedula_cli; ?></td>
                                <td><?php echo $dato->telefono_cli; ?></td>
                                <td><?php echo $dato->direccion_cli; ?></td>
                                <td><?php echo $dato->correo_cli; ?></td>
                                <!--BOTÓN EDITAR-->
