    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrarcita.php" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" name="txtFecha" autofocus required>
                    </div>
                    <!--  Validación simple: autofocus required = los campos son requeridos-->
                    <div class="mb-3">
                        <label class="form-label">Diasnóstico: </label>
                        <textarea type="text" class="form-control" id="exampleFormControlTextarea1" name="txtDesc" rows="7"></textarea>
                    </div>
                    <!--BOTÓN REGISTRAR-->
                    <div class="d-grid">
